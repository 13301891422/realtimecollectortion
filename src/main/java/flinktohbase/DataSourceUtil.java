...
public class DataSourceUtil implements Serializable {
    ...
    static {
        try {
            ...
            props.setProperty("url", "jdbc:mysql://172.16.182.171:3306/data_service?autoReconnect=true");
//            props.setProperty("url", "jdbc:mysql://hadoop105:3306/date_service?autoReconnect=true");
...
//            DruidDataSource druidDS = (DruidDataSource) DruidDataSourceFactory.createDataSource(props);
    ...
    static void closePrepareStatement(PreparedStatement preparedStatement) {
