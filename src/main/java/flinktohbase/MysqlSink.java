...
public class MysqlSink extends RichSinkFunction<String> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        preparedStatement_Alter = connection.prepareStatement("INSERT INTO  alter_table VALUES(?,?,?,?)");
        preparedStatement_Delete = connection.prepareStatement("INSERT INTO  delete_data_table VALUES(?,?,?,?)");
